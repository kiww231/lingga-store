<!DOCTYPE html>
    ...
    <head>
        <meta charset="utf-8" />
        <title>ADMIN LINGGA STORE</title>
            ...
            <div class="content-page">
                        ...
                        <ul class="list-unstyled topbar-menu float-end mb-0">
                            ...
                            <li class="dropdown notification-list topbar-dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                                    <img src="{{asset('assets/admin')}}/images/flags/us.jpg" alt="user-image" class="me-0 me-sm-1" height="12"> 
                                    ...
                                    <div style="max-height: 230px;" data-simplebar>
                                        ...
                                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                                            <div class="notify-icon">
                                                <img src="{{asset('assets/admin')}}/images/users/avatar-2.jpg" class="img-fluid rounded-circle" alt="" /> </div>
                                        ...
                                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                                            <div class="notify-icon">
                                                <img src="{{asset('assets/admin')}}/images/users/avatar-4.jpg" class="img-fluid rounded-circle" alt="" /> </div>
                        ...
                        <div class="app-search dropdown d-none d-lg-block">
                            <form>
                                <div class="input-group">
                                    <a href="{{url('/')}}" target="_blank" class="btn btn-outline-info btn-sm">View Website</a>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <footer class="footer">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-6">
                                <script>document.write(new Date().getFullYear())</script> © Lingga Wedding - linggastore.com
                            </div>
                        </div>
                    </div>
                </footer>
