...
@push('js')
    ...
    <script>
        ...
        $('#switch2').click(function () {
            ...
            $.ajax({
                url: "{{url('admin/article/status')}}/"+id+"/"+status,
                type: 'GET',
                success: function(data){
                    if(data == 'success'){
                        Toast.fire({
                            icon: 'success',
                            title: 'Berhasil Merubah Status Artikel'
                        })
                    }else{
                        Toast.fire({
                            icon: 'error',
                            title: 'Gagal Merubah Status Artikel'
                        })
                    }
                }
            })
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 text-end">
                        <a href="{{url('admin/article/create')}}" class="btn btn-primary btn-sm">Tambah Data</a>
                    </div>
                </div>
                <br>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="text-center" style="width: 5%;">
                                <a href="{{url('admin/article/' . $value->id . '/edit')}}" class="btn btn-sm btn-primary"><i class="mdi mdi-square-edit-outline"></i></a>
