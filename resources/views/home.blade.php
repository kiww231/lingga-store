...
<main id="main">
    ...
    <section id="services" class="services section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4">
          @foreach($feature as $val_feature)
          <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="service-item  position-relative">
              <div class="icon">
                <i class="{{$val_feature->icon}}"></i>
              </div>
    ...
    <section id="get-started" class="get-started section-bg-white">
      <div class="container">
        <div class="section-header" style="padding-top: 70px;">
          <h2>Segera Hubungi Kami Untuk Pemesanan!</h2>
          <a data-aos="fade-up" href="https://wa.me/6285772933413?text='Hallo Admin lingga-store.com'" class="btn-get-whatsapp">Hubungi Kami via WhatsApp</a>
          <p>Pengerjaan maksimal 1x24 jam setelah verifikasi pembayaran dan data lengkap</p>
        </div>
      </div>
    ...
    <section id="recent-blog-posts" class="recent-blog-posts">
        <div class="container" data-aos="fade-up">
            ...
            <div class="row gy-5">
                @foreach($article as $val_art)
                <div class="col-xl-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                    <div class="post-item position-relative h-100">
                        <div class="post-img position-relative overflow-hidden">
                            <img src="{{asset('storage/uploads/article/'.$val_art->thumbnail)}}" class="img-fluid" alt="">
                            <span class="post-date">{{ \Carbon\Carbon::parse($val_art->created_at)->translatedFormat('d F') }}</span>
                        </div>
                        <div class="post-content d-flex flex-column">
                            <h3 class="post-title">{{$val_art->title}}</h3>
                            <div class="meta d-flex align-items-center">
                                <div class="d-flex align-items-center">
                                    <i class="bi bi-person"></i> <span class="ps-2">{{$val_art->user}}</span>
                                </div>
                                <span class="px-3 text-black-50">/</span>
                                <div class="d-flex align-items-center">
                                    <i class="bi bi-folder2"></i> <span class="ps-2">{{$val_art->category}}</span>
                                </div>
                            </div>
                            <hr>
                            <a href="{{url($val_art->slug)}}" class="readmore stretched-link"><span>Read More</span><i class="bi bi-arrow-right"></i></a>
                        </div>
